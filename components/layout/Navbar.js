      ...
      <div className={HeaderStyles.Header}>
          <Navbar className={HeaderStyles.Navbar} collapseOnSelect expand="sm" >
            ...
            <Navbar.Brand href="#home" className={HeaderStyles.brandd}>
                <Image className={HeaderStyles.img} src={Logo} alt="Logo" />
            </Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav" className={HeaderStyles.flexend}>
                <Nav className={HeaderStyles.innernavdiv}>
                    <Nav.Link href="#deets" className={`${HeaderStyles.marginsides} ${HeaderStyles.navlink} ${HeaderStyles.navadjust}`}>
                      About Us
                      {/* <hr className={HeaderStyles.active}></hr> */}
                      </Nav.Link>
                    <Nav.Link eventKey={2} href="#memes" className={`${HeaderStyles.marginsides} ${HeaderStyles.navlink} ${HeaderStyles.navadjust}`}>
                        Our Offers
                    </Nav.Link>
                    <Nav.Link href="##" className={`${HeaderStyles.marginsides} ${HeaderStyles.navlink}`} > Pricing</Nav.Link>
                    <Nav.Link href="#pricing" className={`${HeaderStyles.marginsides} ${HeaderStyles.navlink}`}>FAQs</Nav.Link>
                    <Nav.Link href="#" className={`${HeaderStyles.marginsides} ${HeaderStyles.navlink}`}>Contacts</Nav.Link>

                </Nav>
                <Nav className={HeaderStyles.endnavdiv}>
                  <Button className={`${HeaderStyles.login} ${HeaderStyles.marginsides} ${HeaderStyles.buttonresize} `}>LOG IN</Button>
