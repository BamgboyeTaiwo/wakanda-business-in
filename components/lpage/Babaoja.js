...
export default function Babaoja() {
  return (
    <div
      className={`container   sm:place-content-center   rounded-sm md:px-7 mb-3 lg:rounded-[1.5rem] lg:flex ${styles.container}`}
    >
      <div className={`  ${styles.div_top}`}>
        <div className="md:flex md:flex-row  md:mb-0 sm:p-4 md:relative md:top-[29px]">
          <div className={`md:flex md:flex-col  mb-2 md:relative  `}>
            ...
            <div className="md:flex md:flex-col  md: ml-10 md: pl-10  ">
              <div className="">
                <h1 className="">
                  ...
                  <br />
                  <span className=" font-body  font-semibold sm:text-3xl md:text-4xl ">
          ...
          <div
            className={` ml-auto sm:mb-2  lg:mb-0 md:relative top-[-74.5px] left-[39px]`}
          >
            <Image
              src="/BabaOja2.png"
              alt="BabaOja Image"
        ...
        >
          <button
            className={`sm:mt-3 sm:mb-9  bg-[#00A85A] col-span-6 md:col-span-10 md:col-start-2 sm:col-span-10 sm:col-start-2  font-body  text-white font- tracking-wider shadow-[0_25px_60px_-18px_rgba(2,168,90,0.9)] py-3 rounded-[15px] `}
          >
            GET STARTED NOW {">"}
          </button>
        </div>
