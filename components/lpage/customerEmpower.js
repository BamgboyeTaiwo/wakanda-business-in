    ...
    <section className="bg-[#EFF7F0] pt-4 text-[#163828] font-['Raleway'] ">
        ...
        <div className={`container px-3 ${styles.containerst}`}>
            <div className={`grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12  ${styles}`}>
                ...
                <div className={` sm:hidden md:block lg:block col-span-8 sm:col-span-12 md:col-span-7 lg:col-span-7 lg:pt-2 ${styles.flex2}`}>
                        <div className={`wrapper lg:mt-[10px] ${styles.wrapper}`}>
                            <img src='/images/Group 933.png' className={`absolute ${styles.group933}`} alt="" />
                            <img src='/images/Group 842.png' className={`absolute ${styles.group842}`} alt="" />
                            <img src='/images/Component 62.png' className={`absolute ${styles.messagespng}`} alt="" />
                            <img src='/images/Layer_x-1.png' className={`absolute ${styles.layer_x}`} alt="" />

                        </div>
                </div>

                <div className={`col-span-4 sm:col-span-12 md:col-span-5 lg:col-span-5 ${styles.flexbox}`}>
                    ...
                    <div className={styles.cols}>
                        <div className='grid grid-cols-12 sm:mb-3 lg:mb-3 md:mb-1'>
                            ...
                            <div className={`col-span-9 ${styles.content_title}`}>
                                ...
                                <p>
                                    You customer can also gain access to the Wakanda Market App to sell their products and services 
                                    and also receive free consultation from the BabaOja Wisdom Series.
                                </p>
                            </div>
                        </div>
                        {/* dgcusjf */}
                        ...
                        <div className='grid grid-cols-12  sm:mb-3 md:mb-1 lg:mb-3'>
                            ...
                            <div className={`col-span-9 ${styles.content_title}`}>
                                ...
                                <p>
                                    As your business is growing and evolving, Wakanda CRM tracks the progress 
                                    and provide real time reports on your business performance.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className='grid grid-cols-12  sm:mb-3 md:mb-1 lg:mb-6'>
                            ...
                            <div className={`col-span-9 ${styles.content_title}`}>
                                ...
                                <p>
                                    Your customers can communicate with you and 
                                    also provide their honest feedbacks towards your business with the anonymous voice feature.
                ...
                <div className={`col-span-8 sm:col-span-12 sm:block md:hidden lg:hidden   md:col-span-7 lg:col-span-7 lg:pt-2 ${styles.flex2}`}>
                        <div className={`wrapper lg:mt-[10px] ${styles.wrapper}`}>
                            <img src='/images/Group 933.png' className={`absolute ${styles.group933}`} alt="" />
                            <img src='/images/Group 842.png' className={`absolute ${styles.group842}`} alt="" />
                            <img src='/images/Component 62.png' className={`absolute ${styles.messagespng}`} alt="" />
