...
export default function Babaoja() {
  return (
    <div className="w-full">
      <div
        className={`container w-80 place-content-center  rounded-sm md:px-7 mt-3 mb-3 lg:rounded-[1.5rem] lg:flex ${styles.container}`}
      >
        <div className={`w-full`}>
          <div className="md:flex md:flex-row  md:mb-0 items-center sm:p-4 md:w-full bg-lime-600">
            <div className={`md:flex md:flex-col justify-start  mb-2 w-full `}>
            ...
            <div
              className={` ml-auto sm:mb-2 md:bg-yellow-400 md:w-full lg:w-full md:relative bottom-16 h-96  lg:mb-0`}
            >
              <Image
                src="/BabaOja.svg"
                alt="BabaOja Image"
